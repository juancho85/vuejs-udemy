  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <h1>Animations</h1>
        <hr>
        <select name="alert-animation" id="alert-animation" v-model="alertAnimation" class="form-control">
        ...
        <hr>
        <button class="btn btn-primary" @click="switchSelectedComponent">Switch components</button>
  ...
  export default {
    ...
    methods: {
      beforeEnter(el) {
        ...
        el.style.width = this.elementWith + 'px';
      },
      enter(el, done) {
        console.log('enter');
        let round = 1;
        const interval = setInterval(() => {
          el.style.width = (this.elementWith + round * 10) + 'px';
          round++;
          if(round > 20) {
...
<style>
  ...
  .fade-leave {
    /*opacity: 1; //not needed cause it is implied */
  }
  ...
  /* available with transition-group when elements are moved*/
  .slide-move {
